...
headingLabel = Label(root,text=" Covid 19 Tracker ",font=font,justify = CENTER,fg="red",bg='yellow').pack(side='top')
...
# Label(root, text="Enter all countries names\nfor whom you want to get\ncovid-19 data", font="Consolas 15 bold",activebackground="green").pack(side="top")
Label(root, text="Enter country name:",font=("Helvetica", 15, "bold"), fg='red').place(x=70, y=185)
Label(root, text="Seperate country names using comma or space(not both):",font=("Helvetica", 12), fg='red').place(x=70, y=225)


data = StringVar()

entry = Entry(root, textvariable=data, width=50).place(x=100, y=275)
Button(root, text="Get Data", command=showdata,activebackground="green", bg='yellow',highlightcolor='red').place(x=200, y=315)
root.mainloop()
